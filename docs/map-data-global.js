/* Aeterna welfare map data.
   ...
   Coordinates are building-level and were placed by hand from the addresses in
   the welfare list — treat `approx:true` as "verify on the ground". Every pin
   also carries a `q` search string, so the Directions button resolves by name
   in Google/Apple Maps even if a coordinate is off by a block.
...
window.AE_MAP = {
  ...
  BUILDINGS: [
    ...
    { id: "sunshine",
      ...
      q: "新之城 旺角",
      lat: 22.31680, lng: 114.17075, approx: true,
      shops: [
    ...
    { id: "yimpofong",
      ...
      q: "旺角煙廠街9號",
      lat: 22.31650, lng: 114.17270, approx: true,
      shops: [
    ...
    { id: "kwongwa",
      ...
      q: "旺角廣華街翠園大樓",
      lat: 22.31395, lng: 114.17185, approx: true,
      shops: [
    ...
    { id: "cameron",
      ...
      q: "尖沙咀金馬倫道21C號",
      lat: 22.29970, lng: 114.17420, approx: true,
      shops: [
